...
var_smbuser=${smbuser:-smbuser} # read eviroment variable smbuser, if does not have that variable, default is smbuser
var_smbpassword=${password:-pass} # read eviroment variable password, if does not have that variable, default is pass
